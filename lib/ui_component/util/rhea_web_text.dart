class RheaWebText {
  ...
  static const String landingPageFlowTitle = 'How does Rhea.ai work?';
  ...
  static const Map<String, String> landingFlow = {
    'Share Your Fitness Goals, Preferences, and Health Conditions':
    ...
    'Input Your Daily Updates':
        'Don\'t forget to update the app every day with important info that affects your workout readiness and overall well-being. This includes tracking your menstrual flow, pain levels, mood, anxiety, hydration, energy levels, and readiness to exercise. Your daily inputs help the app\'s AI adjust your workout plan to match your current state.',
